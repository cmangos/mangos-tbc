...
UPDATE creature_template SET ScriptName='npc_theramore_practicing_guard' WHERE entry=4951;
UPDATE creature_template SET HealthMultiplier='1', ScriptName='npc_theramore_combat_dummy' WHERE entry=4952;
