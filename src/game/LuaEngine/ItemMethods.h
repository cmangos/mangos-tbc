...
public:
    ...
    static int GetSpellId(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->Spells[index].SpellId);
        return 1;
    }
    ...
    static int GetSpellTrigger(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->Spells[index].SpellTrigger);
        return 1;
    }
    ...
    static int GetClass(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->Class);
        return 1;
    }
    ...
    static int GetSubClass(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->SubClass);
        return 1;
    }
    ...
    static int GetName(lua_State* L, Item* item)
    {
        ...
        sEluna.PushString(L, item->GetProto()->Name1);
        return 1;
    }
    ...
    static int GetDisplayId(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->DisplayInfoID);
        return 1;
    }
    ...
    static int GetQuality(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->Quality);
        return 1;
    }
    ...
    static int GetBuyCount(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->BuyCount);
        return 1;
    }
    ...
    static int GetBuyPrice(lua_State* L, Item* item)
    {
        ...
        sEluna.PushInteger(L, item->GetProto()->BuyPrice);
        return 1;
    }
    ...
    static int GetSellPrice(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->SellPrice);
        return 1;
    }
    ...
    static int GetInventoryType(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->InventoryType);
        return 1;
    }
    ...
    static int GetAllowableClass(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->AllowableClass);
        return 1;
    }
    ...
    static int GetAllowableRace(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->AllowableRace);
        return 1;
    }
    ...
    static int GetItemLevel(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->ItemLevel);
        return 1;
    }
    ...
    static int GetRequiredLevel(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->RequiredLevel);
        return 1;
    }
    ...
    static int GetRandomProperty(lua_State* L, Item* item)
    {
        ...
        sEluna.PushInteger(L, item->GetProto()->RandomProperty);
        return 1;
    }
    ...
    static int GetRandomSuffix(lua_State* L, Item* item)
    {
        ...
        sEluna.PushInteger(L, item->GetProto()->RandomSuffix);
        return 1;
    }
    ...
    static int GetItemSet(lua_State* L, Item* item)
    {
        ...
        sEluna.PushUnsigned(L, item->GetProto()->ItemSet);
        return 1;
    }
