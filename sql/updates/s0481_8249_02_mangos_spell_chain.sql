ALTER TABLE db_version CHANGE COLUMN required_s0481_8249_01_mangos_spell_proc_item_enchant required_s0481_8249_02_mangos_spell_chain bit;

DELETE FROM `spell_chain` WHERE `spell_id` IN
(8034, 8037, 10458, 16352, 16353, 25501, 8680, 8685, 8689, 11335, 11336, 11337, 26890, 13218, 13222, 13223, 13224, 27189);
