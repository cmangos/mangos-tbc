...
#define TC_LOG_INFO(L, ...)     sLog.outString(F, __VA_ARGS__);
#define TC_LOG_ERROR(L, ...)    sLog.outErrorEluna(F, __VA_ARGS__);
#define TC_LOG_DEBUG(L, ...)    sLog.outDebug(F, __VA_ARGS__);
