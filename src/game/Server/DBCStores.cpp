...
DBCStorage <LanguagesRec> sLanguagesStore(Languagesfmt);
DBCStorage <LanguageWordsRec> sLanguageWordsStore(LanguageWordsfmt);
...
void LoadDBCStores(const std::string& dataPath)
{
    ...
    LoadDBC(availableDbcLocales, bar, bad_dbc_files, sLanguagesStore,           dbcPath, "Languages.dbc");
    LoadDBC(availableDbcLocales, bar, bad_dbc_files, sLanguageWordsStore,       dbcPath, "LanguageWords.dbc");
