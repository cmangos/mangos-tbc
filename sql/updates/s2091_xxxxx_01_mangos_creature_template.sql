ALTER TABLE db_version CHANGE COLUMN required_s2063_12562_01_mangos_playercreateinfo_action required_s2091_xxxxx_01_mangos_creature_template bit;
...
INSERT INTO `creature_template` (`Entry`, `Name`, `SubName`, `IconName`, `MinLevel`, `MaxLevel`, `HeroicEntry`, `ModelId1`, `ModelId2`, `ModelId3`, `ModelId4`, `FactionAlliance`, `FactionHorde`, `Scale`, `Family`, `CreatureType`,
  `InhabitType`, `RegenerateHealth`, `RacialLeader`, `NpcFlags`, `UnitFlags`, `DynamicFlags`, `ExtraFlags`, `CreatureTypeFlags`, `SpeedWalk`, `SpeedRun`,  `UnitClass`, `Rank`, `HealthMultiplier`, `ManaMultiplier`,
  `DamageMultiplier`, `MinLevelHealth`, `MaxLevelHealth`, `MinLevelMana`, `MaxLevelMana`, `MinMeleeDmg`, `MaxMeleeDmg`, `MinRangedDmg`, `MaxRangedDmg`, `Armor`,
  `MeleeAttackPower`, `RangedAttackPower`, `MeleeBaseAttackTime`, `RangedBaseAttackTime`, `DamageSchool`, `MinLootGold`, `MaxLootGold`, `LootId`, `PickpocketLootId`, `SkinningLootId`, `KillCredit1`, `KillCredit2`,
  `MechanicImmuneMask`, `ResistanceHoly`, `ResistanceFire`, `ResistanceNature`, `ResistanceFrost`, `ResistanceShadow`, `ResistanceArcane`, `PetSpellDataId`, `MovementType`, `TrainerType`, `TrainerSpell`, `TrainerClass`, `TrainerRace`,
  `TrainerTemplateId`, `VendorTemplateId`, `EquipmentTemplateId`, `GossipMenuId`, `AIName`, `ScriptName`)
SELECT `entry`, `name`, `subname`, `IconName`, `minlevel`, `maxlevel`, `heroic_entry`, `modelid_1`, `modelid_2`, `modelid_3`, `modelid_4`, `faction_A`, `faction_H`, `scale`, `family`, `type`,
  `InhabitType`, `RegenHealth`, `RacialLeader`, `npcflag`, `unit_flags`, `dynamicflags`, `flags_extra`, `type_flags`, `speed_walk`, `speed_run`, `unit_class`, `rank`, `unk16`, `unk17`,
  `dmg_multiplier`, `minhealth`, `maxhealth`, `minmana`, `maxmana`, `mindmg`, `maxdmg`, `minrangedmg`, `maxrangedmg`, `armor`,
  `attackpower`, `rangedattackpower`, `baseattacktime`, `rangeattacktime`, `dmgschool`, `mingold`, `maxgold`, `lootid`, `pickpocketloot`, `skinloot`, `KillCredit1`, `KillCredit2`,
  `mechanic_immune_mask`, `resistance1`, `resistance2`, `resistance3`, `resistance4`, `resistance5`, `resistance6`, `PetSpellDataId`, `MovementType`, `trainer_type`, `trainer_spell`, `trainer_class`, `trainer_race`,
  `trainer_id`, `vendor_id`, `equipment_id`, `gossip_menu_id`, `AIName`,`ScriptName`
