...
ElunaRegister<Unit> UnitMethods[] =
{
    ...
    {"CastSpell", &LuaUnit::CastSpell},                     // :CastSpell(target, spellID[, triggered]) - Casts spell on target (player/npc/creature), if triggered is false has mana cost and cast time
