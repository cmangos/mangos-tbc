...
void ObjectMgr::LoadGameObjects()
{
    ...
    //                                                0                           1   2    3           4           5           6
    QueryResult* result = WorldDatabase.Query("SELECT gameobject.guid, gameobject.id, map, round(position_x, 20), round(position_y, 20), round(position_z, 20), orientation,"
