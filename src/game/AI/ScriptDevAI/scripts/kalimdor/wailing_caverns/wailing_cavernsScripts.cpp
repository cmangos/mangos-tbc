...
enum
{
    ...
    PATH_ID_NARALEX         = 4300000,                      // Sniffed Waypoints for Escort Event
};
...
struct npc_disciple_of_naralexAI : public npc_escortAI
{
    ...
    {
        m_pInstance = (instance_wailing_caverns*)creature->GetInstanceData();
        Reset();
    }
...
UnitAI* GetAI_npc_disciple_of_naralex(Creature* creature)
{
