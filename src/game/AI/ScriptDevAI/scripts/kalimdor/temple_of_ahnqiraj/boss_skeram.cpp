...
struct boss_skeramAI : public CombatAI
{
    ...
    {
        std::shuffle(m_teleports.begin(), m_teleports.end(), std::mt19937(std::random_device()())); // Shuffle the teleport spells to ensure that boss and images have a different location assigned randomly
        m_teleportCounter = 1;
