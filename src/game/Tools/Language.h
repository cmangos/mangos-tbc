...
//                                      = 783, not used
    ...
    LANG_MULTI_TALENT_TEMPLATE_NUM      = 80016,
    LANG_MULTI_TALENT_TEMPLATE_CURRENT  = 80017,
    LANG_MULTI_TALENT_CREATE            = 80018,
    ...
    LANG_10_PLR_DIFFICULTY_WELCOME      = 80032,
    LANG_10_PLR_DIFFICULTY_NOT_SUPPORT  = 80033,
    LANG_POMELO_DIFFICULTY_NORMAL       = 80034,
    LANG_POMELO_DIFFICULTY_10PLAYERS    = 80035,
    LANG_POMELO_DIFFICULTY_NEED_GLEADER = 80036,
    LANG_POMELO_DIFFICULTY_CHANGED      = 80037,
    LANG_DIFFICULTY_WRONG_MAP           = 80038,
    LANG_CANNOT_USE_IN_COMBAT           = 80039,
    LANG_NO_BODY_TO_REVIVE              = 80040,
    LANG_MUST_IN_TEAM_OR_GROUP          = 80041,
    LANG_PLAYERBOT_SUMMON               = 80042,
    LANG_PLAYERBOT_RECALL               = 80043,
    LANG_PLAYERBOT_JOB_UNSPECIFIED      = 80044,
    LANG_PLAYERBOT_JOB_TANK             = 80045,
    LANG_PLAYERBOT_JOB_DPS              = 80046,
    LANG_PLAYERBOT_JOB_HEAL             = 80047,
    LANG_PLAYERBOT_RECALL_TIP           = 80048,
    LANG_PLAYERBOT_SUMMON_TIP           = 80049,
    LANG_PLAYERBOT_2SIDE_TEAMING_ERR    = 80050,
    LANG_PLAYERBOT_CHARLIST             = 80051,
    LANG_PLAYERBOT_CHARJOB              = 80052,
    LANG_PLAYERBOT_NO_CHARACTER         = 80053,
    LANG_PLAYERBOT_ASSIGNED_JOB         = 80054,
