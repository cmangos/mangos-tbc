...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_PET_XP_KILL_TBC,
    CONFIG_FLOAT_RATE_XP_KILL_TBC,
    CONFIG_FLOAT_RATE_XP_QUEST_TBC,
    CONFIG_FLOAT_RATE_XP_EXPLORE_TBC,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_OVERRIDE_TRADE_CHANNEL,
