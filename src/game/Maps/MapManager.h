...
class MapManager : public MaNGOS::Singleton<MapManager, MaNGOS::ClassLevelLockable<MapManager, std::recursive_mutex> >
{
    ...
    private:
        ...
        DungeonMap* CreateDungeonMap(uint32 id, uint32 InstanceId, Difficulty difficulty, AdvancedDifficulty advancedDifficulty, DungeonPersistentState* save = nullptr);
