...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] =
{
    ...
    /*0x3CB*/ { "CMSG_CHANNEL_SILENCE_VOICE",                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleChannelSilenceOpcode      },
    /*0x3CC*/ { "CMSG_CHANNEL_SILENCE_ALL",                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x3CD*/ { "CMSG_CHANNEL_UNSILENCE_VOICE",                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnsilenceOpcode    },
    ...
    /*0x3D2*/ { "CMSG_SET_ACTIVE_VOICE_CHANNEL",                STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleSetActiveVoiceChannelOpcode},
    ...
    /*0x3D6*/ { "CMSG_CHANNEL_VOICE_OFF",                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleChannelVoiceOffOpcode     },
    ...
    /*0x3DA*/ { "CMSG_ADD_VOICE_IGNORE",                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleAddVoiceIgnoreOpcode      },
    /*0x3DB*/ { "CMSG_DEL_VOICE_IGNORE",                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleDelVoiceIgnoreOpcode      },
    /*0x3DC*/ { "CMSG_PARTY_SILENCE",                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandlePartySilenceOpcode        },
    /*0x3DD*/ { "CMSG_PARTY_UNSILENCE",                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandlePartyUnsilenceOpcode      },
