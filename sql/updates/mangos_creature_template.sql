...
CREATE TABLE `creature_template` (
  ...
  `MinLevelArmor` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `MaxLevelArmor` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `creature_template` (`Entry`, `KillCredit1`, `KillCredit2`, `ModelId1`, `ModelId2`, `ModelId3`, `ModelId4`, `Name`, `SubName`, `IconName`, `GossipMenuId`, `MinLevel`, `MaxLevel`, `MinLevelHealth`, `MaxLevelHealth`,
  `MinLevelMana`, `MaxLevelMana`, `MinLevelArmor`, `MaxLevelArmor`, `FactionAlliance`, `FactionHorde`, `NpcFlags`, `SpeedWalk`, `SpeedRun`, `Scale`, `Rank`, `MinMeleeDmg`, `MaxMeleeDmg`, `DamageSchool`, `MeleeAttackPower`, `DamageMultiplier`,
  ...
  `PetSpellDataId`, `MinLootGold`, `MaxLootGold`, `AIName`, `MovementType`, `InhabitType`, `HealthMultiplier`, `ManaMultiplier`, `RacialLeader`, `RegenerateHealth`, `EquipmentTemplateId`, `TrainerTemplateId`,
  `VendorTemplateId`, `MechanicImmuneMask`, `ExtraFlags`, `ScriptName`, `HeroicEntry`)
SELECT `entry`,`KillCredit1`, `KillCredit2`, `modelid_1`, `modelid_2`, `modelid_3`, `modelid_4`,`name`, `subname`, `IconName`, `gossip_menu_id`, `minlevel`, `maxlevel`, `minhealth`, `maxhealth`,
  `minmana`, `maxmana`, `armor`, `armor`,`faction_A`, `faction_H`, `npcflag`, `speed_walk`, `speed_run`, `scale`, `rank`, `mindmg`, `maxdmg`, `dmgschool`, `attackpower`, `dmg_multiplier`,
  ...
  `PetSpellDataId`, `mingold`, `maxgold`, `AIName`, `MovementType`, `InhabitType`, `unk16`, `unk17`, `RacialLeader`, `RegenHealth`, `equipment_id`,`trainer_id`,
  `vendor_id`, `mechanic_immune_mask`,`flags_extra`, `ScriptName`, `heroic_entry`
