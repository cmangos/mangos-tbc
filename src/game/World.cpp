...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_configFloatValues[CONFIG_FLOAT_RATE_LOYALTY]     = sConfig.GetFloatDefault("Rate.Loyalty", 1.0f);
    ...
    m_configFloatValues[CONFIG_FLOAT_RATE_REPUTATION_LOWLEVEL_KILL]  = sConfig.GetFloatDefault("Rate.Reputation.LowLevel.Kill", 0.2f);
